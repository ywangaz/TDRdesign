...
####---------------------Experiment---------------------####
RUN_tdr_2s_2by2 = function(FILEPREFIX, p0,p1, alphamax, alpha1max, alpha2max, alphamaxmax, betamax, pwrmin, ci=0.9,k=1) {
  ...
  dat = expand.grid(p0=p0,
                   ...
                   nogomin=0.01,
                   etamax=0.99,
                   gammax=seq(0.05,0.20,0.01),
                   expicmax=seq(0.05,0.30,0.05),
                   ci=ci)
...
fileprefix = 'TDR_adhoc_alpha10pwr90_2s_2by2_alphaonly'

RUN_tdr_2s_2by2(FILEPREFIX=fileprefix, p0=0.35, p1=0.55,
                alphamax=0.10, alpha1max=0.99, alpha2max=0.99,alphamaxmax=0.99,
                betamax=0.10, pwrmin=0.90, ci=0.90,
                k=1)
